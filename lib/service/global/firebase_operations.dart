...
class FirebaseOperations with ChangeNotifier {
  ...
  Future uploadPostData(String posId,PostModel data)async{
    return FirebaseFirestore.instance.collection('posts').doc(posId).set(data.toJson());
  }
                ...
                children: <Widget>[
                  Container(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        }, icon: Icon(Icons.camera_alt,size: context.height30*1.5,color: cameraIcon,),),
                        Text(uploadImage,style: TextStyle(color: primaryLight,fontWeight: FontWeight.bold,fontSize: context.height20),)
                      ],):
                    Image.file(
                      uploadPostImage,
                      fit: BoxFit.cover,
                  ...
                  Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          TextApp(text: writeComment,style: TextStyle(color: commentLabel,fontSize: context.height20),),
                          WriteComment(controller: caption,)
                        ],
                      )
                  ),
                  const Spacer(),
                  Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          TextButtonApp(text: ignore,
                            style: TextStyle(color: buttonColor,fontSize: context.height20),
                            onPressed: (){
